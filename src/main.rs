...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Disk persistence for onion address
    if let Some(onion) = service.onion_address() {
        ...
        println!("[+] Address saved to address.txt");
    }
    ...
    println!("WhisperNet active. Type /help.\n");
    ...
    loop {
        ...
        match parts[0] {
            "/help" => println!("Commands: /id, /onion, /connect <addr>, /msg <addr> <txt>, /quit"),
